...
self.addEventListener("fetch", (event) => {
  ...
  // App shell: red primero (para recibir actualizaciones de inmediato),
  // con la copia guardada solo como respaldo si no hay conexión.
